...
#pragma config(Motor,  port1,           rightMotor1,   tmotorNone, openLoop)
#pragma config(Motor,  port2,           rightMotor2,   tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port3,           leftMotor1,    tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port4,           leftMotor2,    tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port5,           intakeMotor,   tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port6,           m6,            tmotorServoContinuousRotation, openLoop)
...
#pragma config(Motor,  port10,          m10,           tmotorNone, openLoop)
//*!!Code automatically generated by 'ROBOTC' configuration wizard               !!*//

// ============================================================================
//
// OCCRA Crab Robot:								Last Update: 10/06/2017
//
// Testing...
// ============================================================================
...
task main () {
	...
	while ( true ) {
		...
		int leftVal = LimitVal( -127, (joy_x - joy_y)/2, 127 );
		mot[leftMotor1]  = leftVal;
		mot[leftMotor2] = leftVal;

		int rightVal = LimitVal( -127, (joy_x + joy_y)/2, 127 );
		mot[rightMotor1] = rightVal;
		mot[rightMotor2] = rightVal;
