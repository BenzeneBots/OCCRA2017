...
task main () {
	...
	while (true) {
		...
		motor[LDrive1] = (int)(leftVal * 0.5);
		motor[LDrive2] =  (int)(leftVal * 0.5);

		motor[RDrive1] =  (int)(0.977 * rightVal * 0.5);
		motor[RDrive2] =  (int) (0.977 * rightVal * 0.5);
