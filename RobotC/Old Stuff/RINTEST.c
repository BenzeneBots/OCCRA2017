...
#pragma config(Motor,  port3,           m3,            tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port4,           m4,            tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port5,           m5,            tmotorServoContinuousRotation, openLoop)
